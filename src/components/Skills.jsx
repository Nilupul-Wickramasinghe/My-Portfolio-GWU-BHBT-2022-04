...
export function Skills() {
  return <section id="skills" className="py-24 px-4 bg-white dark:bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-16 text-center md:text-left">
          Tech <span className="text-[#FF6B35]">Stack</span>
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map(skill => <div key={skill.name} className="bg-white dark:bg-[#1A1A1A] p-6 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-[#FF6B35]/50 transition-colors duration-300">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-gray-900 dark:bg-black rounded-lg text-[#FF6B35]">
                  {skill.icon}
                </div>
