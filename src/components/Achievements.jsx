          ...
          >
            <div>
              ...
              <div className="flex items-center gap-2 text-gray-600 mb-6">
                <Building2 size={18} />
                <span>{achievements[0].institution}</span>
              </div>
            </div>
              ...
              <div className="space-y-3 pt-4 border-t border-gray-200">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-600">Focus Area</p>
                  <p className="text-gray-800">{achievements[0].focusArea}</p>
                </div>
              </div>
            </div>
